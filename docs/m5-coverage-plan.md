...
| 多龙奇 | pokemon | search | 多龙黑夜魔灵/多龙喷火龙/多龙巴鲁托 | A | 现有原语 | blocked:装配复核证伪原原因——实测「查看牌库上方2张选1入手、剩余放回牌库下方」，缺 search_deck top_n 检视 + 剩余卡 deck_bottom 去向（name 过滤器 WP1 已备但本卡不需要）（2026-09-07） |
| 多龙梅西亚 | pokemon | damage_boost | 多龙黑夜魔灵/多龙喷火龙/多龙巴鲁托 | A | vanilla（无需 DSL，装载即可） | done（vanilla 核验：目标印刷无效果句，无需 DSL） |
| 夜巡灵 | pokemon | bounce | 喷火龙大比鸟/多龙黑夜魔灵 | A | 现有原语 | blocked:缺 recover_from_discard bench 去向（name: 过滤器 WP1 已备）（2026-09-07） |
| 奥琳博士的气魄 | trainer | draw,energy_accel | 猛雷鼓厄诡椪 | A | 现有原语 | blocked:缺 attach 多目标各附1（trait:古代 过滤器 WP1 已备，labels←db effect_tags.labels）（2026-09-07） |
...
| 尖钉镇道馆 | trainer | search | 玛俐长毛巨魔雪妖女 | A | 现有原语 | done（task 026 WP1 闸1/2 过，gate3 待核销；owner_pokemon:玛俐 过滤器） |
| 弗图博士的剧本 | trainer | bounce | 喷火龙大比鸟/猛雷鼓厄诡椪/赛富豪/多龙巴鲁托 | A | bounce 原语（task 025 已注册） | done（task 025 代表卡，gate3 已核销 2026-09-06） |
| 彷徨夜灵 | pokemon | status | 喷火龙大比鸟/多龙黑夜魔灵 | A | 现有原语 | blocked（2026-09-06 gate3 核销不过：装配取错印刷——池内两套卡组实际均为 H 标 CSV8C-082「咒怨炸弹」自我昏厥+放置5伤害指示物，需 place_damage_counters + 自我昏厥原语，归 task 026；现 DSL 覆盖的 D 标 CS2.5C-018 奇异之光池内零使用） |
| 怒鹦哥ex | pokemon | draw,energy_accel | 猛雷鼓厄诡椪 | A | 现有原语 | blocked:缺 attach_energy up-to-N + bench-only 目标池（first_own_turn WP1 已备）（2026-09-07） |
...
| 水莲的照顾 | trainer | discard_recover | 赛富豪 | A | 现有原语 | blocked:缺 recover_from_discard hand up-to（min_choose=0；pokemon_no_rule_or_basic_energy 过滤器 WP1 已备）（2026-09-07） |
...
| 牡丹 | trainer | bounce | 赫普的苍响 | A | 现有原语 | blocked:缺 bounce 附着物回手参数（in-play basic_pokemon 过滤器 WP1 已备）（2026-09-07） |
...
| 猫头夜鹰 | pokemon | bounce | 猛雷鼓厄诡椪 | A | 现有原语 | blocked:缺 trigger_on_event 引擎分发（own_tera_in_play WP1 已备）（2026-09-07） |
...
| 白蕾雅 | trainer | modifier | 喷火龙大比鸟 | A | 现有原语 | blocked:缺奖赏修正钩子（opponent_prizes_eq:N + CardDef.is_tera WP1 已备）（2026-09-07） |
| 百变怪 | pokemon | search | 猛雷鼓厄诡椪 | A | 现有原语 | blocked:缺变身替换原语（first_own_turn/self_is_active WP1 已备）（2026-09-07） |
| 皮宝宝 | pokemon | bounce | 喷火龙大比鸟 | A | 现有原语 | done（task 025 闸1/2 过，gate3 已核销 2026-09-06） |
| 米立龙 | pokemon | search,bounce | 赫普的苍响 | A | 现有原语 | blocked:缺牌库顶N检视（self_is_active WP1 已备）（2026-09-07） |
| 索财灵 | pokemon | - | 赛富豪 | A | 现有原语 | blocked:缺 coin_flip until_tails + 正面次数×N 伤害 |
| 紧急滑板 | trainer | modifier | 喷火龙大比鸟/多龙黑夜魔灵/多龙喷火龙/玛俐长毛巨魔雪妖女/赫普的苍响 | A | 现有原语 | blocked:缺 modify_retreat_cost（holder_hp_le:N WP1 已备）（2026-09-07） |
...
| 零之大空洞 | trainer | modifier | 猛雷鼓厄诡椪 | A | 现有原语 | blocked:缺 bench_size 覆写 + 失效缩减结算（CardDef.is_tera WP1 已备）（2026-09-07） |
| 飞天螳螂 | pokemon | energy_accel | 赛富豪 | A | 现有原语 | blocked:缺 bench-only attach 目标池 + attach up-to（energy_<属性> 参数化过滤器 WP1 已备）（2026-09-07） |
...
| 老大的指令 | trainer | gust | 喷火龙大比鸟/猛雷鼓厄诡椪/多龙黑夜魔灵/多龙喷火龙/玛俐长毛巨魔雪妖女/赛富豪/多龙巴鲁托/赫普的苍响 | B | 小原语批（task 025/026） | done（task 026 WP1 闸1/2 过，gate3 待核销；gust 无门控版，38 印刷同文本全挂载） |
